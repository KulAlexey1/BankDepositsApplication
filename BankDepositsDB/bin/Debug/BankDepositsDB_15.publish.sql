...
select @sql_command = @sql_command + concat(N'create trigger ', t.table_schema, '.tgr_', t.table_name, '_insert',
    ...
    'insert into dbo.logs(log_type_id, log_text) values (1, concat(@log_header, '' '', @json, ''.'')) end go')
from

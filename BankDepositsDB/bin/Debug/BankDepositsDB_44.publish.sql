...
GO
PRINT N'Creating [dbo].[fk_deposits_deposit_terms]...';


GO
ALTER TABLE [dbo].[deposits]
    ADD CONSTRAINT [fk_deposits_deposit_terms] FOREIGN KEY ([deposit_term_id]) REFERENCES [dbo].[deposit_terms] ([deposit_term_id]);
